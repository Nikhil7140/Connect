    ...
    private void signOut() {
        ...
        documentReference.update(updates)
                .addOnSuccessListener(aVoid -> {
                    ...
                    startActivity(new Intent(getApplicationContext(), com.example.connect.activities.SignInActivity.class));
                    finish();
                })
                .addOnFailureListener(e -> Toast.makeText(MainActivity.this, "Unable To Sign in", Toast.LENGTH_SHORT).show());
    }
